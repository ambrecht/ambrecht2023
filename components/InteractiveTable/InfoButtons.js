  ...
  return (
    <STYLE>
      <StyledImage
        src={Workspace}
        alt="Workspace"
        layout="fill" // Changed to 'fill' for responsive scaling
        objectFit="contain" // Ensures the image scales properly within its container
      ></StyledImage>
      <SVG viewBox="0 0 1920 900" {...props}>
        <defs>
...
const SVG = styled.svg`
  ...
  height: 100%;
  object-fit: contain;
  z-index: 2; // This ensures SVG scales proportionally with the container
`;
...
const StyledImage = styled(Image)`
  ...
  height: 100%;
  object-fit: contain;
  z-index: 1; // Adjust as needed, 'cover' might also be suitable
`;
