    ...
    <div className="relative">
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <p>
              <strong>Zweck:</strong> Die Typewriter App bietet ein klassisches
              Schreibmaschinengefühl für fokussiertes Schreiben ohne
              Ablenkungen.
            </p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <strong>Fokussiertes Schreiben:</strong> Keine
                Formatierungsoptionen, nur reiner Text.
              </li>
              <li>
                <strong>Automatischer Zeilenumbruch:</strong> Wörter werden
                automatisch in die nächste Zeile verschoben.
              </li>
              <li>
                <strong>Kein vorschnelles Löschen:</strong> Einmal geschriebener
                Text bleibt bestehen, um den Schreibfluss zu fördern.
              </li>
              <li>
                <strong>Vollbildmodus:</strong> Für ablenkungsfreies Schreiben.
              </li>
              <li>
                <strong>Nachtmodus:</strong> Schont die Augen bei schlechten
                Lichtverhältnissen.
              </li>
              <li>
                <strong>Automatische Speicherung:</strong> Ihr Text wird
                automatisch lokal gespeichert.
              </li>
            </ul>

            <p>
              <strong>Optimiert für:</strong> Desktop, Tablet und Mobilgeräte
              (Android, Windows).
            </p>
          </div>
        </div>
